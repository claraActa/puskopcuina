...
class KegiatanBKCUController extends Controller{
 ...
 public function storeUmum(Request $request, $id)
        {
            
		   $kegiatan = Kegiatan::findOrFail($id);
           $this->validate($request,KegiatanPesertaUmum::$rules);

           $kelas = KegiatanPesertaUmum::create(['name'=> $request->name, 'name_nametag'=> $request->name_nametag, 'name_sertifikat' => $request->name_sertifikat, 'lembaga' => $request->lembaga]);
           return response()
           ->json([
            'saved'=> true,
	...
	public function updatePesertaUmum(Request $request, $id)
	{
		$kelas = KegiatanPesertaUmum::findOrFail($id);
	...
	public function countPertanyaan($id, $cu, $user)
	{
      ...
      //  protected $message = 'formulirPendaftaran';
    
        //public function index()
        //{
          ///  $table_data = formulirPendaftaran::select('id','name', 'comment')->advancedFilter();
        ...
        public function formulirPendaftaran()
        {
                ...
                $subtitle = 'SILAHKAN MENGISIDATA DIRI ANDA DIBAWAH ';
                return view('formulirPendaftaran', compact(
					'id',
       				'name',
        			'gender',
        			'pendidikan',
        ...
        public function createFormulirPendaftaran()
        {
            return response()
                ->json([
                        'form'=> formulirPendaftaran::initialize(),
                        'rules'=> formulirPendaftaran::$rules,
                        'option'=>[]
                ]);
        }

        public function destroyFormulirPendaftaran($id)
    {
        $kelas = formulirPendaftaran::findOrFail($id);
        $name = $kelas->name;
        $kelas->delete();
    ...
    public function editFormulirPendaftaran($id)
    {
        $kelas = formulirPendaftaran::findOrFail($id);
        ...
        public function storeFormulirPendaftaran(Request $request)
        {
            
           $this->validate($request,KegiatanPesertaUmum::$rules);
           $kelas = KegiatanPesertaUmum::create([
			'name'=> $request->name, 
        ...
        public function updateFormulirPendaftaran(Request $request, $id)
        {
            $name = $request->name;
            $kelas = formulirPendaftaran::findOrFail($id);
            // processing single image upload

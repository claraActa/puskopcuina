...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    formPendaftaran2: function formPendaftaran2(id) {
      this.$router.push({
        name: this.kelas + 'formPendaftaran',
        params: {
          id: id
        }
      });
                      ...
                      ? _c(
                          "button",
                          {
                            ...
                            on: {
                              click: function ($event) {
                                $event.preventDefault()
                                return _vm.formPendaftaran2(_vm.selectedItem.id)
                              },
                            },
                          },
                          [
                            _c("i", { staticClass: "icon-clipboard6" }),
                            _vm._v(" Formuir Pendaftaran\n\t\t\t\t"),
                          ]
                        )
                      : _vm._e(),
                  ]

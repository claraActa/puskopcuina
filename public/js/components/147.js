...
/* harmony import */ var _formListMateri_vue__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./formListMateri.vue */ "./resources/assets/js/views/kegiatanBKCU/formListMateri.vue");
/* harmony import */ var _formTugas_vue__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./formTugas.vue */ "./resources/assets/js/views/kegiatanBKCU/formTugas.vue");
/* harmony import */ var _formTugasJawaban_vue__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./formTugasJawaban.vue */ "./resources/assets/js/views/kegiatanBKCU/formTugasJawaban.vue");
/* harmony import */ var _formKeputusan_vue__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./formKeputusan.vue */ "./resources/assets/js/views/kegiatanBKCU/formKeputusan.vue");
/* harmony import */ var _formKeputusanKomentar_vue__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./formKeputusanKomentar.vue */ "./resources/assets/js/views/kegiatanBKCU/formKeputusanKomentar.vue");
/* harmony import */ var _formPertanyaan_vue__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./formPertanyaan.vue */ "./resources/assets/js/views/kegiatanBKCU/formPertanyaan.vue");
/* harmony import */ var _formPertanyaanKomentar_vue__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./formPertanyaanKomentar.vue */ "./resources/assets/js/views/kegiatanBKCU/formPertanyaanKomentar.vue");
/* harmony import */ var _formNilai_vue__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./formNilai.vue */ "./resources/assets/js/views/kegiatanBKCU/formNilai.vue");
...
/* harmony import */ var _formPendaftaran_vue__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./formPendaftaran.vue */ "./resources/assets/js/views/kegiatanBKCU/formPendaftaran.vue");
/* harmony import */ var _formulirPendaftaran_vue__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./formulirPendaftaran.vue */ "./resources/assets/js/views/kegiatanBKCU/formulirPendaftaran.vue");
var _mapGetters;
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    formListMateri: _formListMateri_vue__WEBPACK_IMPORTED_MODULE_15__["default"],
    formTugas: _formTugas_vue__WEBPACK_IMPORTED_MODULE_16__["default"],
    formTugasJawaban: _formTugasJawaban_vue__WEBPACK_IMPORTED_MODULE_17__["default"],
    // formPdf,
    formKeputusan: _formKeputusan_vue__WEBPACK_IMPORTED_MODULE_18__["default"],
    formKeputusanKomentar: _formKeputusanKomentar_vue__WEBPACK_IMPORTED_MODULE_19__["default"],
    formPertanyaan: _formPertanyaan_vue__WEBPACK_IMPORTED_MODULE_20__["default"],
    formPertanyaanKomentar: _formPertanyaanKomentar_vue__WEBPACK_IMPORTED_MODULE_21__["default"],
    formNilai: _formNilai_vue__WEBPACK_IMPORTED_MODULE_22__["default"],
    formPendaftaran: _formPendaftaran_vue__WEBPACK_IMPORTED_MODULE_24__["default"],
    formulirPendaftaran: _formulirPendaftaran_vue__WEBPACK_IMPORTED_MODULE_25__["default"]
  },
  data: function data() {
    var _ref;
  ...
  methods: {
    ...
    fetchListMateri: function fetchListMateri(params) {
    ...
    //buka(){
    //	this.$router.push({name:'formPendaftaran'});
    //},
    ...
    generateSertifikat: function generateSertifikat() {
      ...
      axios.post('/api/generateSertifikat', this.selectedItem, {
        ...
        file_saver__WEBPACK_IMPORTED_MODULE_23___default.a.saveAs(response.data, _this.selectedItem.name + '.pdf');
    ...
    downloadMateri: function downloadMateri(filename) {
      if (this.item.tipe == 'diklat_bkcu') {
        axios.get('/api/download_folder/' + filename + '/diklat', {
          ...
          file_saver__WEBPACK_IMPORTED_MODULE_23___default.a.saveAs(response.data, filename);
        });
    ...
    formPendaftaran: function formPendaftaran() {
      this.$router.push({
        name: 'formPendaftaran'
      });
    },
    formulirPendaftaran: function formulirPendaftaran() {
      this.$router.push({
        name: 'kegiatanBKCUformulirPendaftaran'
      });
    },
                                      ...
                                      ? _c(
                                          "button",
                                          {
                                            ...
                                            on: {
                                              click: function ($event) {
                                                $event.preventDefault()
                                                return _vm.formulirPendaftaran(
                                                  _vm.selectedItem.id
                                                )
                                              },
                                            },
                                          ...
                                          [
                                            _c("i", {
                                              staticClass: "icon-clipboard6",
                                            }),
                                            _vm._v(
                                              " Formulir Pendaftaran Diklat\n\t\t\t\t\t\t\t\t\t\t"
                                            ),
                                          ]
                                        )
                                      : _vm.currentUser.can &&
                      ...
                      [
                        _c("tbody", [
                          ...
                          _c("tr", [
                            ...
                            _c("td", { staticClass: "text-right" }, [
                              _vm._v(
                                _vm._s(_vm.item.peserta_max_cu) + " orang"
                              ),
                            ]),
                          ]),
                          _vm._v(" "),
                            ...
                            _c("li", { staticClass: "nav-item" }, [
                              _c(
                                "a",
                                {
                                  staticClass: "nav-link",
                                  class: {
                                    active: _vm.tabName == "listMateri",
                                  },
                                  attrs: { href: "#" },
                                  on: {
                                    click: function ($event) {
                                      $event.preventDefault()
                                      return _vm.changeTab("listMateri")
                                    },
                                  },
                                },
                                [
                            ...
                            directives: [
                              {
                                name: "show",
                                rawName: "v-show",
                                value: _vm.tabName == "listMateri",
                                expression: "tabName == 'listMateri'",
                              },
                            ],
                          },
                          [
                            _c(
                              "data-viewer",
                              {
                                attrs: {
                                  title: "List Materi",
                                  itemData: _vm.itemDataListMateri,
                                  columnData: _vm.columnDataListMateri,
                                  itemDataStat: _vm.itemDataListMateriStat,
                                  query: _vm.queryListMateri,
                                  isNoExcel: "true",
                                  isDasar: "true",
                                  isNoKolom: "true",
                                  isDisable: _vm.isDisableTable,
                                },
                                on: { fetch: _vm.fetchListMateri },
                                scopedSlots: _vm._u(
                                  [
                                    {
                                      key: "button-desktop",
                              ...
                              [
                                _c(
                                  "button",
                                  {
                                    ...
                                    class: {
                                      disabled:
                                        !_vm.itemDataKomentar.prev_page_url,
                                    },
                                    attrs: { href: "#" },
                                    on: {
                                      click: function ($event) {
                                ...
                                _c(
                                  "button",
                                  {
                                    ...
                                    class: {
                                      disabled:
                                        !_vm.itemDataKomentar.next_page_url,
                                    },
                                    attrs: { href: "#" },
                                    on: {
                                      click: function ($event) {
            ...
            ? _c(
                ...
                [
                  _c(
                    ...
                    {
                      class: {
                        "text-danger": _vm.errors.has("formTugas.tipe"),
                      },
                    },
                    [

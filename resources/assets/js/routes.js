...
const menuBaru = () => import('./views/menuBaru/index.vue');
const menuBaru_form = () => import('./views/menuBaru/form.vue');
...
const halamanBaru = () => import('./views/halamanBaru/index.vue');
const halamanBaru_form = () => import('./views/halamanBaru/form.vue');
const halamanSaran = () => import('./views/halamanSaran/index.vue');
const halamanSaran_form = () => import('./views/halamanSaran/form.vue');

const halamanPendaftaran = () => import('./views/halamanPendaftaran/index.vue');
const halamanPendaftaran_form = () => import('./views/halamanPendaftaran/form.vue');
const formPendaftaran = () => import('./views/kegiatanBKCU/formPendaftaran.vue');
const kegiatanBKCU_formPeserta = () =>import('./views/kegiatanBKCU/formPeserta.vue');
const kegiatanBKCU_formUmum = () => import('./views/kegiatanBKCU/formUmum.vue');
const kegiatanBKCU_formulirPendaftaran = () => import('./views/kegiatanBKCU/formulirPendaftaran.vue');
const kegiatanBKCU_formulirPendaftaranDaftarPeserta = () => import("./views/kegiatanBKCU/formulirPendaftaranDaftarPeserta.vue");
const kegiatanBKCU_formulirCoba = () => import("./views/kegiatanBKCU/formulirCoba.vue");
...
const routes = [
  ...
  {
    path: "/kegiatanBKCU/formulirPendaftaran/:id",
    name: "kegiatanBKCUformulirPendaftaran",
    components: {
      default: kegiatanBKCU_formulirPendaftaran,
    },
    meta: { requiresAuth: false },
  },
  {
    path: "/kegiatanBKCU/formUmum/:id",
    name: "kegiatanBKCUformUmum",
    components: {
      default: kegiatanBKCU_formUmum,
    },
    meta: { requiresAuth: false },
  },

  {
    path: "/kegiatanBKCU/formulirPendaftaranDaftarPeserta/:id",
    name: "kegiatanBKCUformulirPendaftaranDaftarPeserta",
    components: {
      default: kegiatanBKCU_formulirPendaftaranDaftarPeserta,
    },
    meta: { requiresAuth: false },
  },

  {
    path: "/kegiatanBKCU/formulirCoba",
    name: "kegiatanBKCUformulirCoba",
    components: {
      default: kegiatanBKCU_formulirCoba,
    },
    meta: { requiresAuth: false },
  },
  ...
  // pendaftaran
  {
    path: "/halamanPendaftaran",
    name: "halamanPendaftaran",
    components: { default: halamanPendaftaran, header: header, footer: footer },
    meta: { requiresAuth: true },
  },
  {
    path: "/halamanPendaftaran/create",
    name: "halamanPendaftaranCreate",
    components: {
      default: halamanPendaftaran_form,
      header: header,
      footer: footer,
    },
    meta: { requiresAuth: true },
  ...
  {
    path: "/halamanPendaftaran/edit/:id",
    name: "halamanPendaftaranEdit",
    components: {
      default: halamanPendaftaran_form,
      header: header,
      footer: footer,
  ...
  // halaman baru
  {
    path: "/halamanBaru",
    name: "halamanBaru",
    components: { default: halamanBaru, header: header, footer: footer },
    meta: { requiresAuth: true },
  },
  {
    path: "/halamanBaru/create",
    name: "halamanBaruCreate",
    components: { default: halamanBaru_form, header: header, footer: footer },
    meta: { requiresAuth: true },
  },

  {
    path: "/halamanBaru/edit/:id",
    name: "halamanBaruEdit",
    components: { default: halamanBaru_form, header: header, footer: footer },
    meta: { requiresAuth: true, mode: "edit" },
  },
  // halaman saran
  {
    path: "/halamanSaran",
    name: "halamanSaran",
    components: { default: halamanSaran, header: header, footer: footer },
    meta: { requiresAuth: true },
  },
  {
    path: "/halamanSaran/create",
    name: "halamanSaranCreate",
    components: { default: halamanSaran_form, header: header, footer: footer },
    meta: { requiresAuth: true },
  },
  {
    path: "/halamanSaran/edit/:id",
    name: "halamanSaranEdit",
    components: { default: halamanSaran_form, header: header, footer: footer },
    meta: { requiresAuth: true, mode: "edit" },
  },
  ...
  //menucoba
  {
    path: "/menuBaru",
    name: "menuBaru",
    components: { default: menuBaru, header: header, footer: footer },
    meta: { requiresAuth: true },
  },
  {
    path: "/menuBaru/create",
    name: "menuBaruCreate",
    components: { default: menuBaru, header: header, footer: footer },
    meta: { requiresAuth: true },
  },
  {
    path: "/menuBaru/edit/:id",
    name: "menuBaruEdit",
    components: { default: menuBaru_form, header: header, footer: footer },
    meta: { requiresAuth: true, mode: "edit" },
  },
  ...
  {
    path: "/kegiatanBKCU/formPendaftaran",
    name: "kegiatanBKCUformPendaftaran",
    components: { default: formPendaftaran },
    meta: { requiresAuth: false },
  },
  {
    path: "/kegiatanBKCU/halamanBaru",
    name: "kegiatanBKCUhalamanBaru",
    components: { default: halamanBaru },
    meta: { requiresAuth: false },
  },
  {
    path: "/kegiatanBKCU/formPeserta",
    name: "kegiatanBKCUformPeserta",
    components: {
      default: kegiatanBKCU_formPeserta,
    },
    meta: { requiresAuth: false },
  },

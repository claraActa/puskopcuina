				...
				<ul class="navbar-nav navbar-nav-highlight">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu">
							...
							<router-link :to="{ name: 'halamanBaru' }" class="dropdown-item" active-class="active" v-if="currentUser.can['create_diklat_bkcu']" exact>
								<i class="icon-clipboard6"></i> Halaman Baru
							</router-link>

							<!-- divider -->
							<div class="dropdown-divider" v-if="currentUser.can['create_diklat_bkcu']"></div>

							<router-link :to="{ name: 'halamanSaran' }" class="dropdown-item" active-class="active" v-if="currentUser.can['create_diklat_bkcu']" exact>
								<i class="icon-clipboard6"></i> Halaman Saran
							</router-link>

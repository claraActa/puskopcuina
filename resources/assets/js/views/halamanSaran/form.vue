						...
						<div class="card">
							<div class="card-body">	
								<div class="row">
									...
									<!-- saran -->
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.saran')}">

											<!-- title -->
											<h5 :class="{ 'text-danger' : errors.has('form.saran')}">
												<i class="icon-cross2" v-if="errors.has('form.saran')"></i>
												saran: <wajib-badge></wajib-badge></h5>

											<!-- text -->
											<input type="text" name="saran" class="form-control" placeholder="Silahkan masukkan Saran" v-validate="'required|min:5'" data-vv-as="saran" v-model="form.saran">

											<!-- error message -->
											<small class="text-muted text-danger" v-if="errors.has('form.saran')">
												<i class="icon-arrow-small-right"></i> {{ errors.first('form.saran') }}
											</small>
											<small class="text-muted" v-else>&nbsp;</small>
										</div>
									</div>
									<!-- rating -->
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.rating')}">

											<!-- title -->
											<h5 :class="{ 'text-danger' : errors.has('form.rating')}">
												<i class="icon-cross2" v-if="errors.has('form.rating')"></i>
												rating: <wajib-badge></wajib-badge></h5>

											<!-- text -->
											<input type="text" name="rating" class="form-control" placeholder="Silahkan masukkan Saran" v-validate="'required|min:5'" data-vv-as="rating" v-model="form.rating">

											<!-- error message -->
											<small class="text-muted text-danger" v-if="errors.has('form.rating')">
												<i class="icon-arrow-small-right"></i> {{ errors.first('form.rating') }}
											</small>
											<small class="text-muted" v-else>&nbsp;</small>
										</div>
									</div>

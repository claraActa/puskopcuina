			...
			<template slot="item-desktop" slot-scope="props">
				<tr :class="{ 'bg-info': selectedItem.id === props.item.id }" class="text-nowrap" @click="selectedRow(props.item)">
					...
					<td v-if="!columnData[2].hide">
						<check-value :value="props.item.saran"></check-value>
					</td>
					<td v-if="!columnData[2].hide">
						<check-value :value="props.item.rating"></check-value>
					</td>
					...
					<div class="card cursor-pointer" @click.prevent="ubahData(props.item.id)">						
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Saran: <span class="text-muted">{{ props.item.saran }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Rating: <span class="text-muted">{{ props.item.rating }}</span></li>
										</ul>
								</div>
							</div>
						</div>					

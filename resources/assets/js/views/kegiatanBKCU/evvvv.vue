								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group" :class="{'has-error' : errors.has('form.nama')}">
											...
											<!-- text -->
											<input type="text" name="nama" class="form-control" placeholder="Silahkan masukkan nama anda" v-validate="'required|min:5'" data-vv-as="nama" v-model="form.saran">

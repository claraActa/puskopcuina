					...
					<div class="card cursor-pointer" @click.prevent="ubahData(props.item.id)">						
						...
						<div class="card-body">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Gender: <span class="text-muted">{{ props.item.gender }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>CU: <span class="text-muted">{{ props.item.cu }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Tgl. Lahir: <span class="text-muted">{{ props.item.tanggal_lahir }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
								...
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Tinggi : <span class="text-muted">{{ props.item.tinggi }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Agama: <span class="text-muted">{{ props.item.agama }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Status Pernikahan: <span class="text-muted">{{ props.item.status }}</span></li>
										</ul>
								</div>
							</div>
						</div>					

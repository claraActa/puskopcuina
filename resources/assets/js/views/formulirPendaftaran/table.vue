			...
			<template slot="item-desktop" slot-scope="props">
				<tr :class="{ 'bg-info': selectedItem.id === props.item.id }" class="text-nowrap" @click="selectedRow(props.item)">
					...
					<td v-if="!columnData[4].hide">
						<check-value :value="props.item.aktivis"></check-value>
					</td>
					<td v-if="!columnData[5].hide">
						<check-value :value="props.item.pendidikan"></check-value>
					</td>
					<td v-if="!columnData[6].hide">
						<check-value :value="props.item.jurusan"></check-value>
					</td>
							...
							<div class="row">
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Kode: <span class="text-muted">{{ props.item.name }}</span></li>
										</ul>
								</div>
								<div class="col-sm-6">
									<ul class="list list-unstyled mb-1">
										<li>Nama: <span class="text-muted">{{ props.item.comment }}</span></li>
										</ul>
								</div>
							</div>
						</div>					

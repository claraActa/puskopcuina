...
Route::group(['middleware' => 'throttle:1000,1'], function () {
   ...
   // Route::get('/kegiatanBKCU/halamanPendaftaran', 'KegiatanBKCUController@index');
    //Route::get('/kegiatanBKCU/halamanPendaftaran/create', 'KegiatanBKCUController@create');
    //Route::post('/kegiatanBKCU/halamanPendaftaran/store', 'KegiatanBKCUController@store');
    //Route::get('/kegiatanBKCU/halamanPendaftaran/edit/{id}', 'KegiatanBKCUController@edit');
    //Route::post('/kegiatanBKCU/halamanPendaftaran/update/{id}', 'KegiatanBKCUController@update');
    //Route::delete('/kegiatanBKCU/halamanPendaftaran/{id}', 'KegiatanBKCUController@destroy');
    Route::get('/kegiatanBKCU/create/{id}', 'KegiatanBKCUController@create');
    Route::post('/kegiatanBKCU/storePeserta', 'KegiatanBKCUController@storePeserta');
    Route::get('/kegiatanBKCU/create','KegiatanBKCUController@create');
    Route::post('/kegiatanBKCU/storeUmum/{id}','KegiatanBKCUController@storeUmum');
    Route::post('/kegiatanBKCU/formUmum/{id}', 'KegiatanBKCUCOntroller@storeUmum');
    

    
    Route::post('/kegiatanBKCU/storePeserta/{id}', 'KegiatanBKCUController@storePeserta');
    Route::get('/kegiatanBKCU/formulirPendaftaran/create/{id}','KegiatanBKCUCOntroller@create');
    Route::get('/kegiatanBKCU/formulirPendaftaran/edit/{id}','KegiatanBKCUCOntroller@edit');
    Route::post('/kegiatanBKCU/formUmum/{id}','KegiatanBKCUCOntroller@storeUmum');


    Route::get('/formPeserta','KegiatanBKCUController@ndex');
    Route::get('/kegiatanBKCU/formPeserta', 'KegiatanBKCUController@index');
    Route::get('/kegiatanBKCU/formPeserta', 'KegiatanBKCUController@index');
    Route::get('/kegiatanBKCU/formPeserta/create', 'KegiatanBKCUController@create');
    Route::post('/kegiatanBKCU/formPeserta/store', 'KegiatanBKCUController@store');
...
Route::group(['middleware' => 'throttle:60,1'], function () {
    ...
    // Route::group(['prefix'=>'v1'],function(){
        ...
        Route::delete('/sertifikatKegiatan/{id}', 'SertifikatController@destroy');
         ...
         // halaman baru
         Route::get('/halamanBaru', 'halamanBaruController@index');
         Route::get('/halamanBaru/create', 'halamanBaruController@create');
         Route::post('/halamanBaru/store', 'halamanBaruController@store');
         Route::get('/halamanBaru/edit/{id}', 'halamanBaruController@edit');
         Route::post('/halamanBaru/update/{id}', 'halamanBaruController@update');
         Route::delete('/halamanBaru/{id}', 'halamanBaruController@destroy');
         
        
        Route::delete('/halamanSaran/{id}', 'HalamanSaranController@destroy');

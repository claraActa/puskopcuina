...
Route::group(['middleware' => 'throttle:60,10'], function () {
	...
	$appRoutes = function() {
		...
		// halamanBaru
		Route::get('/halamanBaru',array( 'as' => 'halamanBaru.form','uses' => 'HalamanBaruController@index'));
		Route::get('/halamanBaru',array( 'as' => 'halamanBaru','uses' => 'HalamanBaruController@halamanBaru'));
		Route::post('/halamanBaru',array( 'as' => 'halamanBaru','uses' => 'HalamanBaruController@store'));
		
		//Route::get('/halamanBaru',array( 'as' => 'halamanBaru','uses' =>'HalamanBaruController@store'));
		Route::post('/kegiatanBKCU/formulirPendaftaran', array( 'as' => 'kegiatanBKCU','uses' => 'KegiatanBKCUController@storePeserta'));
		Route::post('/kegiatanBKCU/formUmum', array( 'as' => 'kegiatanBKCU','uses' => 'KegiatanBKCUController@storePesertaUmum'));
